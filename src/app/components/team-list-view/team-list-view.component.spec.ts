...
describe('TeamListViewComponent', () => {
  ...
  it('should call fill list member cards with information', () => {
    ...
    // Name field
    let name = fixture.debugElement.nativeElement.querySelector('p.list-view__name');
    expect(name).toBeTruthy();

    // Image field
    let image = fixture.debugElement.nativeElement.querySelector('img.list-view__image');
    expect(image).toBeTruthy();

    // City field
    let city = fixture.debugElement.nativeElement.querySelector('p.list-view__city');
    expect(city).toBeTruthy();

    // Contact field
    let contactInfo = fixture.debugElement.nativeElement.querySelector('div.list-view__contact-info');
